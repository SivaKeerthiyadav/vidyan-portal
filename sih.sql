...
--
-- Host: localhost
-- Generation Time: Sep 18, 2023 at 03:01 PM
...
CREATE TABLE `registration` (
  `id` int(11) NOT NULL,
  `aictecode` int(11) NOT NULL DEFAULT 0,
  `clgname` varchar(255) NOT NULL DEFAULT 'Unknown',
  ...
  `mobileno` varchar(255) NOT NULL DEFAULT 'Unknown',
